...
FAILURES = (
    ...
    (("youtube is challenging this connection", "sign in to confirm"),
     "YouTube refused the download from this network address.",
     "YouTube challenges datacenter and VPN addresses. Download the video in a browser, then add the file here as a local clip; or retry on a residential connection, or pick a different video host."),
