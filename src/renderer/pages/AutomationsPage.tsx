            ...
            <div className="mt-2 space-y-2">
              <Panel padded={false}>
                ...
                <div className="divide-y divide-white/[0.06] border-t border-white/[0.06]">
                  ...
                  <Row
                    label="Captions"
                    hint="Local Nemotron transcribes each clip on your GPU, then GLM writes captions through OpenRouter. TikTok captions wait for your review. AI can make mistakes."
                  >
